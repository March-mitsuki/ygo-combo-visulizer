...
export interface FloatFieldValidationOptions extends ValidationOptions {
  gt?: number;
  gte?: number;
  lt?: number;
  lte?: number;
...
export interface FloatFieldInit extends Omit<FieldInit, "type"> {
  validationOptions?: FloatFieldValidationOptions;
}
export class FloatField extends Field<number> {
  readonly validationOptions: FloatFieldValidationOptions;

  constructor(init: FloatFieldInit) {
